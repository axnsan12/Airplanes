...
public class HotseatStartScreen implements Screen {
	private Stage stage;
	private Airplanes game;
	
	public HotseatStartScreen()
	{
	...
	public void resize(int width, int height)
	{
		...
		resumeButton.addListener(new ClickListener() {
		    ...
		    {
				game.config = new GameConfiguration("HOTSEAT");
				game.setScreen(new HotseatScreen());
		    }
		});
		if (GameState.isValidState("HOTSEAT")) {
		...
		newGameButton.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) 
			{
				GameState.ResetState("HOTSEAT");
				game.config = new GameConfiguration("HOTSEAT");
				game.setScreen(new HotseatSettingsScreen());
			}
		});
